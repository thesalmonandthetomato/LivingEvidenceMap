...
system_prompt <- paste(
  ...
  "28. PRIMARY means the pathway represents a central research question, intervention,",
  "    exposure, outcome or conclusion needed to describe the main contribution.",
  "29. SECONDARY means the pathway is independently substantive and meaningfully",
  "    investigated, but is not part of the study's main contribution.",
  "30. Do not use SECONDARY to retain background concepts, contextual mentions or",
  "    incidental measurements. Such concepts must remain unassigned.",
  "31. More than one PRIMARY pathway is allowed only when the study genuinely has",
  "    co-primary substantive questions or contributions.",
  sep = "\n"
)
