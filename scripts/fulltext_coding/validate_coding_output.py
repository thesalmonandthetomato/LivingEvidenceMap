...
def validate(record: dict) -> list[str]:
    ...
    if "schema_version" in record and record["schema_version"] != "fulltext_coding_v1":
        errors.append(f"schema_version must be 'fulltext_coding_v1', got {record['schema_version']!r}")
