# Workflow 09 reference snapshot
#
# Exact plotting code preserved from scripts/reporting/plot_citesource_database_contribution.R for the validated paired
# CiteSource provenance figure. Preserve this file as documentation/reference;
# production runs should continue to use the live script above.
# Reference figure run: 36234050130
